...
InventoryStructure - Module for low-level manipulation routines on inventory data structure
...
The InventoryStructure module provides low-level manipulation routines for handling inventory data structures. It includes functions for managing items and categories within an inventory.
